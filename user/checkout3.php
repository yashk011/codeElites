	...
	<section id="cart_items">
						...
						<div class="bill-to">
							...
							<div class="form-one">
								<form name="form1" action="" method="post" >
									<input type="text" placeholder="id" name="id" required pattern="[0-9]{10}" title="please enter valid id[0-9 and 10 digit only]" style="width:350px; background-color: #0480be">
		...
		<?php
			if(isset($_POST["submit1"]))
			{
				...
				mysqli_query($link,"insert into confirm_order_address values('$_POST[id]','$_POST[firstname]','$_POST[lastname]','$_POST[email]','$_POST[resi]','$_POST[city]','$_POST[pincode]','$_POST[cno]')");

				$res=mysqli_query($link,"select id2 from confirm_order_address order by id2 desc limit 1");
				while($row=mysqli_fetch_array($res))
				{
					$_SESSION["order_id"]=$row["id2"];
				}
    ...
    <?php
	           ...
	           if(isset($_POST["submit1"])){
                    ...
                    foreach ($_COOKIE['item'] as $name1 => $value)   //this is for looping as per cookies if 3 cookies then loop move
                    {
                        ...
                        mysqli_query($link,"insert into sale values('$values11[1]','$values11[2]','$values11[3]','$values11[4]' ,'$_POST[id]' ,'$_POST[cno]')");
                    }
