				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<?php
							...
							$res =  mysqli_query($link ,"select * from {$statement} LIMIT {$startpoint} , {$limit} where product_type = 'Tools' " );
								...
								<div class="single-products">
									...
									<div class="product-overlay">
										...
										<img src="../admin/<?php echo $row["product_image"]  ; ?>"  width="264" height="270"/>
											...
											<h2><?php echo $row["product_price"]." INR"   ;?></h2>
											<p><?php echo $row["product_name"]  ;?></p>
											<a href="product_details2.php?id=<?php echo $row['id'] ;?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>View Description</a>
										</div>
									</div>
								</div>
								<div class="choose">
